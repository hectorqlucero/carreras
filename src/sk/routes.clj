...
(defroutes open-routes
  ...
  (GET "/table_ref/carrera" [] (table_ref/get-carrera))
  (GET "/table_ref/categorias" [] (generate-string (table_ref/get-categorias)))
  ;; End table_ref
  ...
  (GET "/registrar" request [] (home/registrar request))
  (POST "/registrar/save" request [] (home/registrar-save request))
  ;; End home
